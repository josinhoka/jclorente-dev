...
export const softwareExperience = [
  {
    company: "Personal & Technical Projects",
    role: "Backend Developer & Architecture Designer",
    start: "2024",
    end: "Present",
  ...
  {
    company: "CINFO",
    role: "Systems Administration & Web Support",
    start: "2021",
    end: "2021",
    location: "La Coruña",
    description: "Maintained, configured, and resolved incidents in high-availability web platforms and video streaming environments (Tiivii). Programmed automated cameras for online broadcasting events and managed corporate identities using LDAP.",
    technologies: ["Linux", "Docker", "AWS", "PHP", "REST APIs", "LDAP"]
  },
  {
    company: "T-Systems / Inditex",
    role: "Automation & Logistics Systems Engineer",
    start: "2015",
    end: "2020",
    location: "La Coruña",
  ...
  {
    company: "Softtek / General Electric",
    role: "Systems Administration & eBusiness Support",
    start: "2013",
    end: "2015",
    location: "La Coruña",
...
export const operationsExperience = [
  {
    company: "Mallorca Kiteboarding & Sailing Federation",
    role: "Sailing Sports Instructor & Logistics Coordinator",
    start: "2022",
    end: "2024",
